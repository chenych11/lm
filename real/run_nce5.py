...
from models import NCELangModelV5
...
model = NCELangModelV5(sparse_coding=sparse_coding, nb_negative=options.negative,
                       embed_dims=options.embed_size, init_embeddings=[ini_embeds],
